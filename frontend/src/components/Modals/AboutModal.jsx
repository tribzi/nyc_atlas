    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl max-w-xl w-full p-8 relative animate-in zoom-in-95 duration-200">
        ...
        <div className="space-y-4 text-slate-600 leading-relaxed">
          ...
          <p>Questions? Comments? Contact me at <a href="mailto:hi@nycatlas.city" target="_blank" title="contact email" className="text-blue-600 font-bold hover:underline">hi@nycatlas.city</a></p>
